    ...
    <section className="c-space section-spacing" id="about">
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-6 md:auto-rows-[18rem] mt-12">
        ...
        <div className="flex items-end grid-default-color grid-1">
          ...
          />
          <div className="z-10">
            <p className="headtext">Hi, I am Ambar Gupta</p>
            <p className="subtext">
              Over the last year, I have developed my frontend and backend dev
        ...
        <div className="grid-black-color grid-3">
          <div className="z-10 w-[50%]">
            ...
            <p className="subtext">
              Running on IST (Indian Standard Time) — but my code travels faster
              than time zones; open to remote or relocation!
            </p>
          </div>
